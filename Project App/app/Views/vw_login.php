...
<body class="text-center">
    ...
    <main class="form-signin">
        ...
        <form method="post" action="<?= base_url(); ?>/login/process">
            ...
            <p class="mt-5 mb-3" style="color : white;">Belum punya akun? <a class="nav-link" href="<?= base_url('register'); ?>">Register</a>
            <p class="mt-5 mb-3 text-muted">&copy; Pemrograman Web</p>
        </form>
    </main>
</body>
